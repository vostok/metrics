...
namespace Vostok.Metrics.Primitives.Gauge
{
    ...
    public static class IntegerGaugeFactoryExtensions
    {
        ...
        public static IIntegerGauge CreateIntegerGauge([NotNull] this IMetricContext context, [NotNull] string name, [CanBeNull] IntegerGaugeConfig config = null)
			=> GlobalCache.Obtain(context, name, () => new IntegerGauge(context, MetricTagsMerger.Merge(context.Tags, name), config ?? IntegerGaugeConfig.Default));
        ...
        public static IMetricGroup<TFor, IIntegerGauge> CreateIntegerGauge<TFor>([NotNull] this IMetricContext context, [NotNull] string name, [CanBeNull] IntegerGaugeConfig config = null)
            => GlobalCache.Obtain(context, name, () => new MetricGroup<TFor, IIntegerGauge>(MetricForTagsFactory(context, name, config ?? IntegerGaugeConfig.Default)));
