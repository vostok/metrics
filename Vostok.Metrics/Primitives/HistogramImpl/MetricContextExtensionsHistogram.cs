...
namespace Vostok.Metrics.Primitives.HistogramImpl
{
    ...
    public static partial class MetricContextExtensionsHistogram
    {
        ...
        /// <summary>
        /// <para>
        /// Creates a group of <see cref="IHistogram">Histograms</see>.
        ...
        /// <param name="config">Optional config</param>
        /// <inheritdoc cref="IHistogram"/>
        public static ITaggedMetricT<TFor, IHistogram> Histogram<TFor>(this IMetricContext context, string name, ITypeTagsConverter<TFor> typeTagsConverter = null, HistogramConfig config = null)
        {
            config = config ?? HistogramConfig.Default;
