...
namespace Vostok.Metrics
{
    ...
    {
        /// <summary>
        /// <para>Converts internal metric state to one or several <see cref="MetricEvent">MetricSamples</see>.</para>
        /// <para>Implementation could reset the state after this method was called.</para>
        /// </summary>
        /// <returns><see cref="MetricEvent">MetricSamples</see> describing current state of the metric</returns>
